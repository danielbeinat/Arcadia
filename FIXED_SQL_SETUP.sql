-- SETUP SQL FINAL CORREGIDO - AcademiaNova
-- Este SQL elimina todo y crea la base de datos desde cero sin errores
...
CREATE POLICY "Users can create their enrollments" ON enrollments FOR INSERT WITH CHECK (auth.uid() = student_id);
...
('Ingeniería en Sistemas', 'Formación integral en desarrollo de software', 4, 240, 'Ingeniería',
 ...
 ARRAY['Programación I', 'Programación II', 'Algoritmos', 'Base de Datos']),

('Administración de Empresas', 'Gestión empresarial moderna', 4, 220, 'Ciencias Económicas',
 ARRAY['Bachillerato completo', 'Examen de admisión'],
 ARRAY['Contabilidad', 'Marketing', 'Finanzas', 'Recursos Humanos']),

('Psicología', 'Estudio del comportamiento humano', 5, 300, 'Ciencias Humanas',
 ARRAY['Bachillerato completo', 'Examen psicométrico'],
 ARRAY['Psicología General', 'Neuropsicología', 'Psicología Clínica']),

('Diseño Gráfico', 'Comunicación visual y diseño digital', 3, 180, 'Bellas Artes',
 ARRAY['Bachillerato completo', 'Portfolio'],
 ARRAY['Fundamentos del Diseño', 'Diseño Digital', 'Branding']);

-- Cursos (ARRAY[]::text[] para arrays vacíos)
...
('Marketing Digital', 'Estrategias de marketing digital', 'MKT201', 3, 4, 30, 'Aula B-105', 'Mar/Jue 10-11:30 AM', ARRAY['Marketing I']),
('Cálculo Diferencial', 'Fundamentos del cálculo diferencial', 'MAT101', 4, 1, 35, 'Aula C-302', 'Lun/Mié/Vie 8-9 AM', ARRAY[]::text[]),
