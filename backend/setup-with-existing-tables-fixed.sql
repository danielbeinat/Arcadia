-- SQL Setup para AcademiaNova con tablas existentes - CORREGIDO
-- Compatible con las tablas: users, courses, degrees, enrollments (IDs tipo TEXT)
...
-- PASO 11: Función para actualizar vectores de búsqueda en users
...
CREATE OR REPLACE FUNCTION get_user_performance_summary(user_uuid TEXT)
RETURNS TABLE (
...
-- PASO 23: Actualizar vectores de búsqueda para datos existentes
...
GRANT EXECUTE ON FUNCTION get_user_performance_summary(TEXT) TO authenticated;
...
BEGIN
    ...
    RAISE NOTICE '🎯 Compatible con IDs tipo TEXT';
