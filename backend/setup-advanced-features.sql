...
-- ============================================
-- 4. ENHANCED COURSE SYSTEM
-- ============================================

-- Create courses table (if not exists from previous setup)
CREATE TABLE IF NOT EXISTS courses (
    ...
    duration TEXT, -- e.g., "4 months", "1 semester"
...
-- Add search vector column to existing users table if not exists
ALTER TABLE users ADD COLUMN IF NOT EXISTS ts_vector tsvector;
...
-- Performance metrics policies (users can view their own)
...
DO $$
BEGIN
    RAISE NOTICE '✅ Advanced features setup completed successfully!';
    ...
    RAISE NOTICE '👥 Course enrollment system active';
