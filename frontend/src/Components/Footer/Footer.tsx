          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-white mb-4">
                Instituto <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Arcadia</span>
              </h3>
              <p className="text-slate-400 text-sm leading-relaxed">
                Formando profesionales de excelencia con educación de calidad y compromiso con el futuro.
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="px-4 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 
