    ...
    >
      ...
      <div className="flex-1 p-6 flex flex-col">
        ...
        <div className="mt-auto pt-6 flex flex-col gap-3">
          <div className="w-full text-center py-3 rounded-xl bg-indigo-50 text-indigo-700 font-semibold text-sm hover:bg-indigo-100 transition">
            Ver más información
          </div>
          {onEnroll && (
            <button
              ...
              className="w-full text-center py-3 rounded-xl bg-indigo-600 text-white font-semibold text-sm hover:bg-indigo-700 transition shadow-md hover:shadow-lg"
            >
              Inscribirme
            </button>
          )}
